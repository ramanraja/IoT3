...
SLEEP_TIME = 100            # milli seconds between packet requests

# 16x4 thermal camera:
CAMERA_TYPE = 'MLX 90621'
ROWS = 4
COLS = 16
...
print ('Usage: python ThermalCam.py [sensor_ip] [interpolation] [color_palette] [min_temperature] [max_tempeature]')

print ("Thermal camera type: {}".format(CAMERA_TYPE))

if (len(sys.argv) > 1):
    REMOTE_UDP_IP_ADDRESS = (sys.argv[1])
print ("Sensor IP address: {}".format (REMOTE_UDP_IP_ADDRESS))
print ("Sensor UDP port: {}".format (REMOTE_UDP_PORT_NO))
